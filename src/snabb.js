// Generated from Snabbdom 3.5.1, under MIT License, Copyright (c) 2015 Simon Friis Vindum
// Edited version from 21 Jun 2022
...
class VNode {
  constructor(sel, data, children, text, elm) {
    this.sel = sel;
    this.data = data;
    if (data !== undefined) this.key = data.key;
...
function vnode(sel, data, children, text, elm) {
  return new VNode(sel, data, children, text, elm);
}
...
function init(modules, domApi, options) {
    ...
    function createElm(vnode, insertedVnodeQueue) {
        ...
        let data = vnode.data;
        if (data !== undefined) {
            const initFunc = (_a = data.hook) === null || _a === void 0 ? void 0 : _a.init;
            if (isDef(initFunc)) {
                initFunc(vnode);
                data = vnode.data;
            }
...
// fragment = vnode(undefined, {}, c, text, undefined)
...
export { array, attachTo, attributesModule, classesModule,
  datasetModule, eventListenersModule, htmlDomApi, init,
  primitive, propsModule, styleModule, toVNode, vnode, VNode };
